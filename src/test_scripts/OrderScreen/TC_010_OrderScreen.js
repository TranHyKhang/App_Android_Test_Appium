...
describe('Test Detail Tour function', () => {
    ...
    it('Check children number with another number', () => {


        DetailTour.increaseChildrenNumber()
        
        let childrenNumberInDetail =  Number(DetailTour.getChildrenNumber.getText());

        DetailTour.clickOnButtonBookTour();

        let childrenNumberInOrder = Number(OrderScreen.getChildrenNumber);

        expect(childrenNumberInOrder).toBe(childrenNumberInDetail);
