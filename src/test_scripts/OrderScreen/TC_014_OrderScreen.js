...
describe('Test Detail Tour function', () => {
    ...
    it('Check total money with another adults and children number', () => {

        let tourPrice = Number(DetailTour.getTourPrice);

        DetailTour.increaseAdultsNumber().increaseChildrenNumber().clickOnButtonBookTour();

        let rs = OrderScreen.checkTotalMoneyIsValid(tourPrice);
